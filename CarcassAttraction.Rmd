...
---
title: "Roadkill Carcass Attraction of Large Carnivores and Solutions"
author: "Clayton Lamb"
date: '`r format(Sys.time(), "%d %B, %Y")`'
output: github_document
---

#####WATCH FOR BEFORE AFTER COMPARISONS THAT ARE MORESO ELKO VS ALEX, NOT AS MUCH ELKO BEFORE/AFTER
#####WATCH FOR DENNING AND IMMEDIATELY AFTER CAPTURE LOCS
#####PROBABLY NEED TO CLEAN CONFLICT DATA, AND SEE IF SPARWOOD 2019 SPIKE IS AMYS CUB?

```{r render, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, results='hide'}
rmarkdown::render(here::here('CarcassAttraction.Rmd'),
...
```{r avail, message=FALSE, warning=FALSE}
...
## Plot
```{r plot selection, message=FALSE, warning=FALSE}
df.uncont%>%
...
```{r body condition, message=FALSE, warning=FALSE}
...
```
## Highway crossings before/after
```{r crossings, message=FALSE, warning=FALSE}
...
```{r conflicts, message=FALSE, warning=FALSE}
library(readxl)
...
```{r closer, message=FALSE, warning=FALSE}
